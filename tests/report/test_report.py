...
class TestReport(unittest.TestCase):
    ...
    def test_should_return_false_and_log_error_on_save_when_no_replies(self, mock_logger):
        ...
        mock_logger.assert_has_calls([mock.call.error('There are no pages to be rendered')])
    ...
    def test_should_return_false_and_log_error_on_save_when_no_pages_rendered(self, mock_logger):
        ...
        mock_logger.assert_has_calls([
            mock.call.info('Please wait while generating report...'),
            mock.call.error('There are no pages to be rendered')])
    ...
    def test_should_return_true_on_successful_save(self, mock_logger):
        ...
        mock_logger.assert_has_calls([
            mock.call.info('Saved file as %s', os.path.abspath('/path/to/file'))])
    ...
    def test_should_populate_metadata_from_configuration(self, mock_resource_stream):
        ...
        mock_resource_stream.return_value = FakeFileObject(rb'''[metadata]
author=Za\u017c\xf3\u0142\u0107
creator=G\u0119\u015bl\u0105
subject=Ja\u017a\u0144
...
''')
        ...
        self.assertEqual('Za\u017c\xf3\u0142\u0107', report._document.metadata.author)
        self.assertEqual('G\u0119\u015bl\u0105', report._document.metadata.creator)
        self.assertEqual('Ja\u017a\u0144', report._document.metadata.subject)
        self.assertEqual('Odpowiedzi z 3 bank\xf3w dla 1 zobowi\u0105zanego.', report._document.metadata.title)
        self.assertEqual('dolor', report._document.metadata.keywords)
